...
class App extends Component {
  ...
  render() {
   ...
   <p className="Info-Business"><b>Téléphone:</b> 000000000.</p>
  ...
  <h3 className="Container-LégalNotice">Hébergement</h3>
   ...
   <p className="Info-Business"><b></b></p>
   <p className="Info-Business"><b>Adresse :</b></p>
   <p className="Info-Business"><b>Téléphone :</b></p>
   </div>
   </div>
   </div>
    );
