        ...
        return (
            <div className="Contact">
                ...
                <div className="Contactcontainer">
                    <div className="contactContainer">
                        <h2 className="legendContact">Renseignements</h2>
                        ...
                        <p className="TextLorem">Le Lorem Ipsum est simplement du faux texte employé dans
                    ...
                    <div className="ContainerMap">
                        <h2 className="legendContact">Carte</h2>
